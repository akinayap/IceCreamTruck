...
public class Utils {
    ...
    public static void saveLocalUser(Context context, int icon,String username, String email, String id) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.SHARED_PREFERENCES, Context.MODE_PRIVATE);
        sharedPreferences.edit()
                .putInt(Constants.PREFERENCES_USER_ICON, icon)
    ...
    public static int getLocalUserIcon(Context context){
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.SHARED_PREFERENCES, Context.MODE_PRIVATE);
        return sharedPreferences.getInt(Constants.PREFERENCES_USER_ICON, Constants.DEFAULT_ICON);
    }
